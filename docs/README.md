...
- **[Subagent sessions specification](/docs/SUBAGENT-SPEC.md)** — one research-assistant subagent tool with effort budgets, live progress in the tool card, and persisted child sessions openable in the ordinary session view. Implemented; the specification records the design, implementation paths, and remaining work.
