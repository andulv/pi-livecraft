...
- **[Embedded terminal specification](/docs/EMBEDDED-TERMINAL.md)** — planned server-side PTY shell in a viewer-pane Terminal tab. Not yet implemented; a specification and task plan, not a guide.
