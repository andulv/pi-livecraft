...
This frontend-only feature derives request, model, and tool activity from the current session snapshot plus durations observed during the current Pi Livecraft run. It can navigate back to a conversation message or tool call.
