...
- `terminal/` renders the workspace-scoped embedded shell in a viewer-pane Terminal tab, with ordered input forwarding and resumable output. See [terminal](/src/features/terminal/README.md).
