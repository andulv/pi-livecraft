...
- `browser/` renders the viewer pane's browser tab — a sandboxed iframe with an address bar for human-driven browsing. See [browser](/src/features/browser/README.md).
