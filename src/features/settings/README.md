...
Read [how to add a settings tab](../../docs/HOW-TO-SETTINGS.md) for the tabbed modal structure, or [commands](../commands/README.md) for palette entries and shortcuts, or [right sidebar](../right-sidebar/README.md) for widget state.
