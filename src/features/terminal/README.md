...
Focused coverage: `test/terminal-client.test.ts` (keyboard semantics, ordering/coalescing, and output parsing) and `test/terminal-session.test.ts` (backend contract).
