...
`useWorkspaceSessions` owns workspace selection and the session lists shown by the application. It coordinates initial selection, refreshes, creation, reopening, renaming and closing, optimistic naming, pending UI requests, and the local persistence of recent workspaces and completed sessions.
