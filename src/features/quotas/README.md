...
- Z.AI peak-pricing hours (14:00–18:00 UTC+8, ×3 quota) on a 24-hour local-day bar: labeled boundary hours, the word "peak" centered under the window, and a red highlight while the current time is inside it;
