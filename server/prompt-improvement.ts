...
export const promptImprovementSystemPrompt = [
  ...
  '5. Extract as much as the draft provides. Do not guess or fill gaps.',
  '6. Omit empty sections. Do not write a section just to say that information is missing.',
  '',
  'Output format (use only relevant sections):',
  'Objectif: [goal stated in the draft]',
  'Éléments concernés: [files, modules, or boundaries stated in the draft]',
  'Contraintes: [constraints stated in the draft]',
  'Résultat attendu: [expected outcome stated in the draft]',
  '',
